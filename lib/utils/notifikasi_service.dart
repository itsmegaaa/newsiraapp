...
class NotifikasiService {
  ...
  static Future<void> inisialisasi() async {
    ...
    // Pakai parameter bernama 'settings'
  ...
  static Future<void> tampilkanNotif(String judul, String isi) async {
    ...
    const NotificationDetails detail = NotificationDetails(android: androidDetail);

    // SOLUSI FINAL: Berikan nama (id:, title:, body:, notificationDetails:)
    // Ini akan menghilangkan error "0 expected, but 3 found"
